...
| P0 | Create package | Form to enter prospect info and pick/upload an asset for every slot (video, a second video, audio, business card, up to 3 magazines/features, letter text, brochures, three clickable book images, an optional decorative pen) |
