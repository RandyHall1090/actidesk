...
- **Confirm-email blocker — still open**: Supabase's "Confirm email" setting was ON, reintroducing the corporate-email-scanning problem login already moved away from. Randy turned it off (2026-09-08), but a fresh live signup test right after still came back unconfirmed with no session — see spec/plan.md for detail. Needs another look at the dashboard setting.
