...
**Files:**
- Create: `supabase/migrations/0027_integrations.sql`
...
```bash
git add supabase/migrations/0027_integrations.sql src/lib/integrations/crypto.ts .env.example
