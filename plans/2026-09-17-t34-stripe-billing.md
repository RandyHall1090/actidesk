...
**Files:**
- Create: `supabase/migrations/0028_billing_columns.sql` (renumbered 2026-09-17: 0026/0027 were claimed by T36/T38, built first)
...
```bash
git add supabase/migrations/0028_billing_columns.sql .env.example package.json package-lock.json
